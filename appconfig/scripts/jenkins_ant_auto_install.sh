#########################################################################################
#  Description:	 Script to Autoamatic Installation of Ant
#  Author: Bhawna Goyal
#  Date: 19/03/2017
#  Action History
...
exit_error_parameter() {
	echo "Script to Autoamatic Installation of Ant - "
...
java -jar ${SCRIPTS_PATH}/jenkins-cli.jar -s ${JENKINS_URL} groovy ${SCRIPTS_PATH}/add_ant_auto_installer.groovy --username ${JENKINS_USER} --password ${JENKINS_PWD} | tee -a $FILE_LOG
sleep 5
