#########################################################################################
#  Description:	 Script to Set Slave Agent port
#  Author: Bhawna Goyal
#  Date: 19/03/2017
#  Action History
...
echo "Setting Slave Agent Port ....." | tee -a $FILE_LOG
java -jar ${SCRIPTS_PATH}/jenkins-cli.jar -s ${JENKINS_URL} groovy ${SCRIPTS_PATH}/set_slave_agent_port.groovy --username ${JENKINS_USER} --password ${JENKINS_PWD} | tee -a $FILE_LOG
sleep 5
