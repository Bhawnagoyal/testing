#########################################################################################
#  Description:	 Script to create pipeline using git in Jenkins- jenkins_create_pipeline_git.sh
#  Author: Bhawna Goyal
#  Date: 19/03/2017
#  Action History
...
Pipeline_Conf=${SCRIPTS_PATH}/../config/pipeline-git.xml
Pipeline_Name=pipeline-git
